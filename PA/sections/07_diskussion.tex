...
Die zentrale Domänentrennung löst einen methodischen Widerspruch. Hierbei profitiert SfM von unmaskierten Hintergrundmerkmalen, während STS und objektmaskierte
...
Aussage zur Bodenauflösung (Ground Sampling Distance, GSD: reale Objektgröße
eines Bildpixels) wäre erst mit einer Maßstabsreferenz zulässig. Daraus folgen
zwei Konsequenzen: Erstens dürfen Auflösungen nicht in einer globalen Rangliste
verglichen werden. Zweitens sind nur gepaarte Vergleiche von STS gegen SuGaR
innerhalb derselben Auflösung belastbar. Ein strengerer
...
\begin{enumerate}
  ...
  \item Der normale Inline-Vollauf und der Matrixrunner sind als
	  ...
	  (Abschnitt~\ref{sec:versuchsaufbau}). Der Autopilot ist über neun erfolgreiche
