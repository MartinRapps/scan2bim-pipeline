...
Produktionsweg mit \texttt{SIMPLE\_RADIAL} schätzt dagegen zunächst eine
Verzeichnung und erzeugt anschließend eine separate ideale Szene. OPENCV kann
zusätzliche Verzeichnungsanteile modellieren, besitzt aber mehr Freiheitsgrade.
Aus den Bildmetriken allein lässt sich daher keine generell beste
Kamerakonfiguration ableiten.
