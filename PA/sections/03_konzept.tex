...
Diese vollständige Domänenkette ist heute in allen Ausführungsformen
einheitlich verankert: Matrixpfad, Replay-Dispatcher und interaktiver
Vollauf rufen nach COLMAP denselben Maskenwarp mit anschließender
Coverage-Prüfung auf. Lediglich das Diagnoseprofil \texttt{colmap-stop}
beendet den Lauf nach der COLMAP-Auswertung; auch hier werden die Rohmasken
vor dem Stopp gewarpt, sodass der Zwischenstand mit einem Replay ab
\texttt{sts} fortsetzbar bleibt. Bild und Maske liegen damit in jedem
Fortsetzungsstand gemeinsam in der idealen Szene.
...
bei low, jeweils inklusive SAM3-, COLMAP-, Render- und Archivierungsanteil);
