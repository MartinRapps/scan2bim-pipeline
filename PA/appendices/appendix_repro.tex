...
Kameramodellabbildung in die ideale Domäne gewarpt. Interaktiver Vollauf,
Replay-Dispatcher und Matrixpfad nutzen dabei dieselbe Warp- und
Coverage-Kette; auch das Diagnoseprofil \texttt{colmap-stop} warpt vor dem
Stopp, sodass ein Replay ab \texttt{sts} fortsetzen kann.
...
\end{itemize}
  ...
  \begin{description}
    ...
    \item[Replay] startet mit \texttt{--from} an einer Schrittgrenze und setzt
      konsistente vorhandene Artefakte voraus; ein Replay ab
      \texttt{colmap} schließt den Maskenwarp selbst ein.
...
unter \path{data/10_runs/matrix_repeat_20260812/}. Die Metriken der beiden
