...
Die Rohdatei \mbox{\path{data/01_raw/Alurohr_THWS.mp4}} ist ein H.264-Video mit
...
Die Bezeichnung \enquote{unverfälschtes Video} ist dabei auf die fehlende zusätzliche
...
Videostabilisierung vollständig deaktiviert war. Die vorliegende Arbeit behauptet daher keine
...
Produkte der vorliegenden Arbeit sind die lokale Centerline und der Grad-10-B-Spline. Auch die
STS-Gaussians und das Mesh sind wichtige Produkte, besonders weil sie später
georeferenziert und beispielsweise in der ESRI-Suite verwendet werden können.
Masken und COLMAP-Modell sind dagegen notwendige und diagnostisch wichtige
Zwischenprodukte. Die GeoJSON-Dateien werden ebenfalls erzeugt, aber wegen der
noch fehlenden unabhängigen Transformations- und Vermessungsreferenz nicht als
global genaue Endprodukte bewertet.

\subsection{Referenzlage und Aussagegrenzen}

Für den aktuellen Testdatensatz liegt keine unabhängig eingemessene
GNSS-Referenzkurve vor. Vorhandene GCP-Dateien sind Approximationen der
Wirklichkeit; sie wurden ausschließlich erstellt und verwendet, um die
Transformation selbst zu testen. Fehlt eine validierte
...
Daraus folgt die zentrale Abgrenzung: Die vorliegende Arbeit bewertet Funktionsfähigkeit,
