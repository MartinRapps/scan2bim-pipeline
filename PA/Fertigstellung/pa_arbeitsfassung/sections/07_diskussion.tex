...
beobachtete stille oder verspätete Fehler; der Inline-Vollauf nutzt dieselbe
Gate-/Warp-Kette, während der Replay über den \texttt{--from}-Dispatcher
weiterhin einen passenden idealen Maskensatz voraussetzt.
...
BIM und Vermessung ist 720p trotzdem überlegen: Ein Pixel im 720p-Bild
entspricht in der realen Welt nur wenigen Millimetern, während ein Pixel in
Low einen deutlich größeren realen Lagefehler darstellt. Die Konsequenz ist
...
schneidet in den Ansichtsmetriken stringent schlechter ab. Sie bleibt
...
enthalten. Für die Bachelorarbeit müssen Rohmetriken und geometrische
