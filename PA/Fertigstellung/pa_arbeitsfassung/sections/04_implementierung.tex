...
\texttt{eca4ea1} & \path{gaussian_splatting/scene/dataset_readers.py},
\path{sugar_scene/cameras.py}, \path{sugar_scene/gs_model.py} &
Normalisierte feste Eval-Splits und Schutz gegen nicht gematchte Kameras.\\
\texttt{a0fc37b} (final) & \path{gaussian_splatting/scene/dataset_readers.py},
\path{sugar_scene/gs_model.py} &
Explizite Prüfung der Kameranamen des festen Eval-Splits; damit ist die
Split-Kardinalität abgesichert.\\
\bottomrule
\end{tabularx}
...
Parent-Gitlink, Fork-Checkout und Docker-Parameter \texttt{SUGAR\_REF}
verweisen konsistent auf den Fork-Commit \texttt{a0fc37b} auf dem Zweig
\texttt{project/masked-sugar}; genau dieser Stand wurde in allen archivierten
Matrix- und Folgeläufen verwendet. Die vollständige Fork-Historie ab
\texttt{48bbfdd} sowie der zugehörige Diff liegen als Datei
\path{sugar_fork_diff_48bbfdd_a0fc37b.diff} im digitalen Anlagenband.
...
da der DN-Term des Forks erst oberhalb des Zählerstands 9000
