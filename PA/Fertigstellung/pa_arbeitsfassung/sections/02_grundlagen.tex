...
umfasst 7000 Gesamtiterationen, aufgeteilt in 5000 Iterationen des
Objektcurriculums und 2000 Iterationen der All-Object-Phase. Da im vorliegenden
...
Die beiden maskennutzenden Verlustpfade des SuGaR-Coarse-Trainings verwenden
...
die historischen Zwischenstände in Abbildung~\ref{fig:pa-panel-mesh}, dass die
\texttt{middle}-Stufe die Objektabgrenzung visuell stabilisiert.
...
Division durch null bei temporär leeren Masken. Die weitergehende
Oberflächenangleichung von SuGaR (Depth-Normal-Consistency, bei der Normalen
aus der gerenderten Tiefe mit den Gaussian-Ausrichtungen abgeglichen werden)
ist im lokalen Trainingsplan erst für Iterationen oberhalb von 9000
vorgesehen. Standardläufe mit Zieliteration 9000 optimieren die Geometrie
daher primär über diesen maskierten photometrischen Farbverlust.
...
daher aus dem unterschiedlichen Trainingszustand der Gaussians (z.\,B. 7000
Iterationen STS gegenüber 9000 Iterationen SuGaR-Coarse-Optimierung), nicht
aus dem Dateiformat.
