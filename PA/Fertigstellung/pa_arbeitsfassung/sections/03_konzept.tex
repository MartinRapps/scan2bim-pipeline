...
restaurierten Smoke-/Replaypfad nachgewiesen. Der normale Inline-Vollauf ist
auf denselben Stand gebracht: Nach COLMAP ruft er denselben Maskenwarp mit
identischer Abbildungsvorschrift auf, prüft die Abdeckung der gewarpten
Masken und übergibt \path{data/03_masks_ideal} an STS und SuGaR. Eine
Ausnahme bleibt der Replay über den allgemeinen \texttt{--from}-Dispatcher,
der keine eigene Warp-Stufe besitzt und deshalb einen bereits in die ideale
Domäne gebrachten Maskensatz voraussetzt. Aussagen über die vollständig
gewarpte Bild-/Maskendomäne beziehen sich entsprechend auf Matrix-, Smoke-
und Inline-Volläufe sowie Replays ab \texttt{sts}; ein Replay ab
\texttt{colmap} benötigt einen von vornherein passenden idealen Maskensatz.
...
Arbeitsvideoauflösung (720p, QHD oder low) und weist dabei die aus den
Matrixläufen gemittelten Laufzeiten der Produktionskonfiguration aus
(720p $\approx$ 34 Minuten, QHD $\approx$ 27 Minuten, low $\approx$ 19 Minuten);
das Preset dient der bewussten Wahl zwischen Bildauflösung und Rechenaufwand.
Der Autopilot übernimmt validierte Defaults, wählt automatisch das
720p-Preset mit allen Standardeingaben und überspringt den manuellen
