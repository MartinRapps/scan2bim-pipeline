...
\begin{itemize}
  ...
  \item 4.096 SIFT-Merkmale, Sequential-Overlap 15, Guided Matching aus;
  \item STS 7.000 Gesamtiterationen, Stage-2-Fenster 5.000;
...
zusätzlich im finalen Laufmanifest dokumentiert; das Laufmanifest ist Teil des
\path{ABGABE_Index.md} im Anlagenband und verweist auf das Projektrepository
(\parencite{scan2bimImplementation}).
