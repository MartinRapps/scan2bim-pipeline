...
Kameramodellabbildung in die ideale Domäne gewarpt. Der normale Inline-Vollauf
ruft denselben Maskenwarp vor STS auf; im Replay-Dispatcher gilt dasselbe für
alle Läufe mit frischem COLMAP-Lauf (Start ab \texttt{gcp}, \texttt{sam3}
oder \texttt{colmap}). Nur Replays ab \texttt{sts}, \texttt{sugar} oder
\texttt{postprocess} erwarten einen bereits passenden idealen Maskensatz.
