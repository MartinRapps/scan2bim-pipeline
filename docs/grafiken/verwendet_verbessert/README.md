# Verwendete und verbesserte Grafikquellen
...
- `matrix_thesis_data.csv`: historische kombinierte Quelle;
- `matrix_thesis_method.md`: Methodik und Einschränkungen der historischen
  Tabellen.
