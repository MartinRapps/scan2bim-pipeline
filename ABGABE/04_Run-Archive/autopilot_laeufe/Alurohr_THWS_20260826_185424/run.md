...
- **Run-ID:** `Alurohr_THWS_20260826_185424`
- **Input:** `data/01_raw/Alurohr_THWS.mp4`
- **Start Lauf:** `2026-08-26T18:54:24+0200`
- **Host UID/GID:** `190290584/190200513`
- **Git Commit:** `f794dcd`
- **SuGaR Commit:** `a0fc37b`
- **Logdatei:** `data/10_runs/Alurohr_THWS_20260826_185424/run.log`
